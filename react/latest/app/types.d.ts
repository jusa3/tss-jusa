...
export type AutocompleteWidgetProps = EuiComboBoxProps<string> & ParameterObj & ApiObj & CssClassNameObj & UseLegacyObj & {
    /**
...
export type OnNavigateToEntity = {
     ...
     */
    onNavigateToEntity?: ((ontologyId: string, entityType?: string, entity?: EntityData) => void) | string;
};
...
export type TitlePresentationProps = TitleTextObj & CssClassNameObj & OptionalThingTypeObj & OptionalOntologyIdObj & {
    iri?: string | null;
    title?: string | null;
    defaultValue?: string;
    isLoading?: boolean;
...
export type SearchResultsListWidgetProps = Partial<Omit<EuiCardProps, "layout">> & ApiObj & TargetLinkObj & ParameterObj & UseLegacyObj & CssClassNameObj & {
    /**

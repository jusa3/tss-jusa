import{r as c,b as t}from"./iframe-CTDlrwV_.js";import{l as y,x as i}from"./widgetDescriptions-BWQxYL9a.js";const a=5;function m(e){const[o,r]=c.useState(!1),l=e.className||"ts4nfdi-entity-onto-list-style";function s(n){return t.jsx("button",{onClick:()=>{e.onNavigateToOntology&&e.onNavigateToOntology(n,e.entityType||"",{iri:e.iri,label:e.label})},children:t.jsx("span",{className:"ontology-badge",children:n.toUpperCase()})},i())}function d(){return e.ontolist.length>a&&!o?t.jsxs(t.Fragment,{children:[e.ontolist.slice(0,a).map(n=>t.jsxs("span",{children:[s(n)," "]},i())),t.jsxs("button",{className:"expand-onto-list",onClick:()=>r(!0),children:["+ ",e.ontolist.length-a]})]}):e.ontolist.map(n=>t.jsxs("span",{children:[s(n)," "]},i()))}return t.jsx("div",{className:l,children:e.ontolist&&e.ontolist.length>0&&t.jsxs(y,{style:{fontWeight:"normal"},children:["Also appears in ",d()]})})}m.__docgenInfo={description:"",methods:[],displayName:"EntityOntoListPresentation",props:{entityType:{required:!1,tsType:{name:"entityTypeNames[number]",raw:"typeof entityTypeNames[number]"},description:"Sets the type of the entity whose information you want to fetch."},iri:{required:!0,tsType:{name:"string"},description:"Entity IRI whose information you want to fetch."},onNavigateToOntology:{required:!1,tsType:{name:"union",raw:`((
  ontologyId: string,
  entityType?: string,
  entity?: EntityData,

import{b as r}from"./iframe-CTDlrwV_.js";import{O,u as w,m as E,l as L,r as I,bc as S}from"./widgetDescriptions-BWQxYL9a.js";import{E as v}from"./EntityOntoListPresentation-CQ2vfsq5.js";function j(b){const{iri:o,api:m,parameter:l,entityType:i,ontologyId:d,useLegacy:a,className:h}=b,g=new O(m),{data:s,isLoading:f,isSuccess:u,isError:T,error:k}=w(["entityOntoList",m,l,i,o,d,a],async()=>{let n,y,c;if(a){const e=(await g.getEntityResponse(o,i,void 0,l,a))._embedded,p=e[Object.keys(e)[0]].filter(t=>t.is_defining_ontology).map(t=>t.ontology_name);n=e[Object.keys(e)[0]].map(t=>t.ontology_name).filter(t=>!p.includes(t)),y=i||S(Object.keys(e)[0]),c=e[Object.keys(e)[0]][0].label}else{const e=await g.getEntityObject(o,i,d,l,a);n=e.getAppearsIn().filter(p=>!e.getDefinedBy().includes(p)),y=i||e.getType(),c=e.getLabel()||""}return n=n.filter(e=>e!=d).sort(),{ontoList:n,entityType:y,label:c}});return r.jsxs("div",{"data-testid":"entity-onto-list",children:[u&&s&&r.jsx(v,{ontolist:s.ontoList,entityType:s.entityType,label:s.label,iri:o,onNavigateToOntology:b.onNavigateToOntology,className:h}),f&&r.jsx(E,{}),T&&r.jsx(L,{children:I(k,"ontology list")})]})}j.__docgenInfo={description:"",methods:[],displayName:"EntityOntoListWidget",props:{api:{required:!0,tsType:{name:"string"},description:"The API instance for the API call."},entityType:{required:!1,tsType:{name:"entityTypeNames[number]",raw:"typeof entityTypeNames[number]"},description:"Sets the type of the entity whose information you want to fetch."},ontologyId:{required:!0,tsType:{name:"string"},description:"Select a specific ontology by id"},iri:{required:!0,tsType:{name:"string"},description:"Entity IRI whose information you want to fetch."},parameter:{required:!1,tsType:{name:"string"},description:`Additional parameters to pass to the API.
